        ...
        private void send_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (radioButton2.Checked)
                {
                    ...
                    string ta = ch4Shuaijian + ch2Shuaijian + ch3Shuaijian + ch1Shuaijian;
                    string ra = new string('0', 24);
                    string tp = ch4Yixiang + ch2Yixiang + ch3Yixiang + ch1Yixiang;
                ...
                else if (radioButton1.Checked)
                {
                    ...
                    string ra = ch4Shuaijian + ch2Shuaijian + ch3Shuaijian + ch1Shuaijian;
                    string tp = new string('0', 24);
                    string rp = ch4Yixiang + ch2Yixiang + ch3Yixiang + ch1Yixiang;
